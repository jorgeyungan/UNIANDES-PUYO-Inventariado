...
public class crudUbicacion {
    ...
    public static ArrayList<clsUbicacion> findtoasignacion() {
        ArrayList<clsUbicacion> listado = new ArrayList<>();
        String sql = "SELECT\n"
                + "\"public\".ubicacion.idubicacion,\n"
                + "\"public\".ubicacion.edificio,\n"
                + "\"public\".ubicacion.piso,\n"
                + "\"public\".ubicacion.carrera,\n"
                + "\"public\".ubicacion.sala,\n"
                + "\"public\".ubicacion.sector\n"
                + "FROM\n"
                + "\"public\".ubicacion\n"
                + "WHERE\n"
                + "\"public\".ubicacion.sector = '' OR\n"
                + "\"public\".ubicacion.sala = 'SALA DE PROFESORES'";
        ArrayList<Parametro> lstPar = new ArrayList<>();
        try {
            ConjuntoResultado cres = AccesoDatos.ejecutaQuery(sql, lstPar);
            clsUbicacion ubi = null;
